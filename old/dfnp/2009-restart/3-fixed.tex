...
\begin{verbatim}
\includepdf[pages=062]{hertel/all.pdf}One Vishnusharman, shrewdly gleaning
All worldly wisdom's inner meaning,
In these five books the charm compresses
Of all such books the world possesses.
\end{verbatim}
...
\end{verbatim}
\includepdf[pages=063]{hertel/all.pdf}``Now there is a Brahman here named Vishnusharman, with a reputation for competence in numerous sciences. Intrust the princes to him. He will certainly make them intelligent in a twinkling.''
...
\includepdf[pages=064]{hertel/all.pdf}Here then begins Book I, called ``The Loss of Friends.'' The
first verse runs:
...
\includepdf[pages=065]{hertel/all.pdf}Presently he reached a forest lovely with grisleas, acacias,
...
\includepdf[pages=066]{hertel/all.pdf}It had no timidity about any foreign forest, and no alarms.
...
\includepdf[pages=067]{hertel/all.pdf}``And that is why I say that meddling should be avoided by the intelligent. And you know,''
he continued,
...
\begin{verbatim}
\includepdf[pages=068]{hertel/all.pdf}The jobless man is hired
    For careful serving;
...
\includepdf[pages=069]{hertel/all.pdf}For naughty meddlers suffer
...
\includepdf[pages=070]{hertel/all.pdf}One who, even in distress,
...
\includepdf[pages=071]{hertel/all.pdf}Cringe, and flatter him when angry;
...
\includepdf[pages=072]{hertel/all.pdf}Lacking honor from their equals,
...
\end{verbatim}
``Oh,'' said Rusty,
\includepdf[pages=073]{hertel/all.pdf}``you must not say such things. You are our counselor's son, an old retainer.''
``O King,'' said Victor,
...
\end{verbatim}
\includepdf[pages=074]{hertel/all.pdf}And yet again:
...
\begin{verbatim}
\includepdf[pages=075]{hertel/all.pdf}Its voice was fierce; I thought it stuffed
...
\begin{verbatim}
\includepdf[pages=076]{hertel/all.pdf}All counselors draw profit from
...
\begin{verbatim}
\includepdf[pages=077]{hertel/all.pdf}The earth has a limit,
...
\includepdf[pages=078]{hertel/all.pdf}There is a city called Growing City on the earth's surface.
...
\end{verbatim}
\includepdf[pages=079]{hertel/all.pdf}Now one morning, as he was sweeping near the bed where the
...
Then, holy sage, you find
    A woman true.
\end{verbatim}
\includepdf[pages=080]{hertel/all.pdf}And once again:
...
\includepdf[pages=081]{hertel/all.pdf}
...
``O King,'' said Bull,
\includepdf[pages=082]{hertel/all.pdf}``I was awake all night because I am passionately fond of gambling. So drowsiness overcame me in the very act of doing my sweeping. I do not know what I was muttering. Pardon me, master. I was really asleep.''
...
\includepdf[pages=083]{hertel/all.pdf}entrée. More than that, as soon as they lacked the lion's
...
\includepdf[pages=084]{hertel/all.pdf}In a certain district there was a monastery in a secluded
...
\includepdf[pages=085]{hertel/all.pdf}being thus indifferent to the world in early youth. What says
the proverb?
...
\includepdf[pages=086]{hertel/all.pdf}So, the sleeping arrangements being made, Godly graciously
...
\includepdf[pages=087]{hertel/all.pdf}``Well, well! This is a dull-witted jackal. If he happens to be between just when they crash, he will certainly meet death. This inference seems inescapable to me.''
...
\end{verbatim}
\includepdf[pages=088]{hertel/all.pdf}And once again:
...
\includepdf[pages=089]{hertel/all.pdf}since he had previously heard the gossip that went the rounds
...
\end{verbatim}
\includepdf[pages=090]{hertel/all.pdf}And once again:
...
\includepdf[pages=091]{hertel/all.pdf}So the wench freed the barber's wife, took her former
...
\includepdf[pages=092]{hertel/all.pdf}Honey in a woman's words,
...
\includepdf[pages=093]{hertel/all.pdf}Meanwhile the go-between went home with her nose cut off, and
reflected:
...
\end{verbatim}
\includepdf[pages=094]{hertel/all.pdf}While, on the other hand:
...
\begin{verbatim}
\includepdf[pages=095]{hertel/all.pdf}Drink, women, hunting, scolding, dice,
...
\includepdf[pages=096]{hertel/all.pdf}In a certain region grew a great banyan tree. In it lived a
...
``But,'' said his wife,
\includepdf[pages=097]{hertel/all.pdf}``this is a terribly venomous snake. How will you hurt him?''
And he replied:
...
\includepdf[pages=098]{hertel/all.pdf}And the heron replied:
...
\includepdf[pages=099]{hertel/all.pdf}implored, lifted some in his bill, carried them a certain
...
\end{verbatim}
\includepdf[pages=100]{hertel/all.pdf}Again:
...
\includepdf[pages=101]{hertel/all.pdf}the golden chain in the snake's hole and waited at a safe
distance.
...
\end{verbatim}
\includepdf[pages=102]{hertel/all.pdf}And yet again:
...
\includepdf[pages=103]{hertel/all.pdf}``Well, gentlemen, you are quite convincing. But if an animal does not come to me every day as I sit here, I promise you I will eat you all.''
...
\includepdf[pages=104]{hertel/all.pdf}``Well, tell it quick, before you are between my fangs.''
...
\includepdf[pages=105]{hertel/all.pdf}A single archer from a wall
...
\includepdf[pages=106]{hertel/all.pdf}``Master, who can endure your majesty? The moment he saw you, that thief crawled clear into his hole. Come, I will show him to you.''
...
\includepdf[pages=107]{hertel/all.pdf}In the Molasses Belt is a city called Sugarcane City. In it
...
\includepdf[pages=108]{hertel/all.pdf} burning sighs he tumbled on the bed (though it had not been
...
\includepdf[pages=109]{hertel/all.pdf}If fate has willed
    That I should die,
Are there no means
    Save that soft eye?
...
\includepdf[pages=110]{hertel/all.pdf}But when you trust another
...
\includepdf[pages=111]{hertel/all.pdf}Then the weaver, hope reviving at his friend's promise, rose
...
\includepdf[pages=112]{hertel/all.pdf}``It is a thing beyond my fondest aspirations.'' And he
...
\end{verbatim}
\includepdf[pages=113]{hertel/all.pdf}Again:
...
\includepdf[pages=114]{hertel/all.pdf}``There is none other on earth so blest as you and I, whose child blessed Vishnu seeks with love. All the desires nearest our hearts are granted. Now, through the power of our son-in-law, I shall reduce the whole world to subjection.''
...
\includepdf[pages=115]{hertel/all.pdf} After this address, he bade them provide adequate defense for
the walls and gates.
...
\includepdf[pages=116]{hertel/all.pdf}puts an end to every heart's desire. But death is mine if I
...
\includepdf[pages=117]{hertel/all.pdf}Hereupon the weaver, inspired by Vishnu, gave instructions to
Lovely:
...
\end{verbatim}
\includepdf[pages=118]{hertel/all.pdf}What means this marvel?” Thus Brahma himself was astonished.
...
\begin{verbatim}
\includepdf[pages=119]{hertel/all.pdf}When those appointed to advise
...
\begin{verbatim}
\includepdf[pages=120]{hertel/all.pdf}The man who loves not royalty,
...
\includepdf[pages=121]{hertel/all.pdf}Tried servants never should be left,
    And strangers taken;
...
\includepdf[pages=122]{hertel/all.pdf}In a certain town lived a Brahman whose name was Sacrifice.
...
\includepdf[pages=123]{hertel/all.pdf}Next the monkey said: ``Holy sir, pull me out too.'' And the
...
\includepdf[pages=124]{hertel/all.pdf}whatever. As he started for home, he recalled the monkey's
...
\includepdf[pages=125]{hertel/all.pdf}When the Brahman was fettered, he remembered the snake, who
...
\includepdf[pages=126]{hertel/all.pdf}“And that is why I say:
...
\end{verbatim}
\includepdf[pages=127]{hertel/all.pdf}``How can that be?'' said the lion. And Victor answered:
...
\includepdf[pages=128]{hertel/all.pdf} be free from morbidity, since wind, bile, and phlegm are kept
...
\includepdf[pages=129]{hertel/all.pdf}scorpion, as if touched by a torch, bounded to his feet,
...
\includepdf[pages=130]{hertel/all.pdf}somewhere. Nobody knows what his conduct might be, or his
...
\includepdf[pages=131]{hertel/all.pdf}“And that is why I say:
...
\end{verbatim}
\includepdf[pages=133]{hertel/all.pdf}“Yet, after all, the fault is mine, because I made advances
...
\includepdf[pages=134]{hertel/all.pdf}``I am going to my own home, which is called Lotus Grove. If you set any value on me and feel any affection, you must not fail to pay a visit as my guest.''
...
\end{verbatim}
\includepdf[pages=135]{hertel/all.pdf}“Yes, I have learned by experience the truth of the
well-known verse:
...
\includepdf[pages=136]{hertel/all.pdf}Where Jumna's waves roll blue
...
\includepdf[pages=137]{hertel/all.pdf}grass. Thus in a very few days the poor fellow regained his
strength.
...
\includepdf[pages=138]{hertel/all.pdf}``But after all, the master guaranteed his personal security, and so cannot kill him.''
...
\includepdf[pages=139]{hertel/all.pdf} to our gracious master, then we must follow him into the
...
\includepdf[pages=140]{hertel/all.pdf}you, the master would scarcely prolong his life. Besides,
...
\includepdf[pages=141]{hertel/all.pdf}``Well, they used the most elegant phrases. Yet the master did not kill a single one of them. So I, too, will make a speech befitting the occasion. I have no doubt that all three will contradict me.''
...
\includepdf[pages=142]{hertel/all.pdf}In a certain city lived a carpenter named Trust-god. It was
...
\includepdf[pages=143]{hertel/all.pdf}``I don't go anywhere,'' said he. But when they urged the
...
\end{verbatim}
\includepdf[pages=144]{hertel/all.pdf}And once again:
...
\begin{verbatim}
\includepdf[pages=145]{hertel/all.pdf}What man is rash enough to take
...
\end{verbatim}
\includepdf[pages=146]{hertel/all.pdf}And there is sound sense in this:
...
But they objected:
\includepdf[pages=147]{hertel/all.pdf}``There is a hitch in this fine plan. If you happen to indulge in the smallest conversation, then you will lose your hold on the stick, will fall from a great height, and will be dashed to bits.''
...
\includepdf[pages=148]{hertel/all.pdf}``This looks bad. Tomorrow or the day after they will be sure to come here. I will take Readywit and Fatalist and move to another lake whose waters are not troubled.''
...
On a different plan.
\end{verbatim}
\includepdf[pages=149]{hertel/all.pdf}Feel no anxiety. Who can bring humiliation upon you while my
arms protect you?”
...
\includepdf[pages=150]{hertel/all.pdf}``with a bill that holds one drop how will you dry up the ocean, into which pour without ceasing the Ganges and the Indus, bearing the water of nine times nine hundred tributary streams? Why talk nonsense?''
But the plover said:
...
\includepdf[pages=151]{hertel/all.pdf}branch where the sparrows had their nest, and broke it. In
...
\end{verbatim}
\includepdf[pages=152]{hertel/all.pdf}And again:
...
\includepdf[pages=153]{hertel/all.pdf}“And that is why I say:
...
\includepdf[pages=154]{hertel/all.pdf}that in course of time it wound its way up the tree.
...
\includepdf[pages=155]{hertel/all.pdf}the birds reported to their master, the king of the birds,
...
\includepdf[pages=156]{hertel/all.pdf}``Messenger, what will the master do with so poor a servant as I am?''
...
\end{verbatim}
\includepdf[pages=157]{hertel/all.pdf}``Come, then, so that we may recover the eggs from ocean, may satisfy the plover, and then proceed to the celestial city on the gods' business.''
...
\includepdf[pages=158]{hertel/all.pdf}In a part of a forest lived a lion named Thunder-Fang, in
...
\includepdf[pages=159]{hertel/all.pdf}``If that is possible, my friend, my body shall be so devoted. Tell the master that this thing should be done. I stipulate only that the Death-God be requested to guarantee the bargain.''
...
laughed and said:
\includepdf[pages=160]{hertel/all.pdf}``Come, come! You ate the camel's heart all by yourself. Why do you look at me?''
...
\includepdf[pages=161]{hertel/all.pdf}Having thus set his mind in order, he started very slowly,
...
\includepdf[pages=162]{hertel/all.pdf}Snake, lion, elephant, and fire,
...
Whoever wish them lonely are
    Their adversaries.
\end{verbatim}
\includepdf[pages=163]{hertel/all.pdf}And again:
...
\includepdf[pages=164]{hertel/all.pdf}``Master, all the forest kings have become turbulent, and in their midst is the forest chief named Vindhyaka. It is the king's affair to teach him modest manners.''
...
\includepdf[pages=165]{hertel/all.pdf}presence, after settling all disturbances in the forest
...
\includepdf[pages=166]{hertel/all.pdf}When she heard this, the wife felt her heart swell with
...
\includepdf[pages=167]{hertel/all.pdf}On hearing this, all her elderly relatives without exception
...
\includepdf[pages=168]{hertel/all.pdf}“And that is why I say:
...
What peering effort could reveal
    His nakedness?
\end{verbatim}
\includepdf[pages=169]{hertel/all.pdf}“Since, then, you are a villain, good advice is thrown away
...
\end{verbatim}
\includepdf[pages=170]{hertel/all.pdf}“Ah, there is wisdom in the saying:
...
\includepdf[pages=171]{hertel/all.pdf}Before long, Wrong-Mind exhausted his preliminary portion
...
\includepdf[pages=172]{hertel/all.pdf}will reveal to you which one of us is guilty, which not
...
\includepdf[pages=173]{hertel/all.pdf}``what am I to do? Fate is against me. My babies and the youngsters belonging to my relatives have been eaten by a snake that lives in a hole in the fig tree. Grieved at their grief, I weep. Tell me, is there any possible device for killing him?''
...
\includepdf[pages=174]{hertel/all.pdf}men heard this statement, their eyes blossomed with
...
\includepdf[pages=175]{hertel/all.pdf}Oh, may no evil e'er befall
...
\includepdf[pages=176]{hertel/all.pdf}``Lakshman, you are in no way to blame, if it has been eaten by mice. Such is life. Nothing in the universe has any permanence. However, I am going to the river for a bath. Please send your boy Money-God with me, to carry my bathing things.''
...
\includepdf[pages=177]{hertel/all.pdf}``What am I to do? Before my eyes a hawk carried him from the river-bank.''
...
\end{verbatim}
\includepdf[pages=178]{hertel/all.pdf}“Indeed, there is wisdom in the old story:
...
\includepdf[pages=179]{hertel/all.pdf}``In another part of the forest I met another parrot who looked like you, but who had a cruel disposition. `Bind him, bind him!' he cried; `kill him, kill him!'\,''
...
\includepdf[pages=180]{hertel/all.pdf}go. And the merchant's son said:
...
\includepdf[pages=181]{hertel/all.pdf}outskirts, an old bird in a cage began to sing{\textemdash}this bird
...
\begin{verbatim}
\includepdf[pages=182]{hertel/all.pdf}When that last hour arrives, that none,
...
\includepdf[pages=183]{hertel/all.pdf}learning his prime minister, planned to seize the kingdom of
...
\includepdf[pages=184]{hertel/all.pdf}a blow at the bee{\textemdash}a blow that split the king's head.
...
\includepdf[pages=185]{hertel/all.pdf}him, I have only hurt myself. For the proverb says:
...
\includepdf[pages=186]{hertel/all.pdf}The wise discover in wise books
...
\includepdf[pages=187]{hertel/all.pdf}``The Winning of Friends.'' The first verse runs:
...
\includepdf[pages=188]{hertel/all.pdf}greedily sought to eat them and alighted in the great snare.
...
\includepdf[pages=189]{hertel/all.pdf}efforts to carry the snare away, flew just an arrow-shot into
...
\end{verbatim}
\includepdf[pages=190]{hertel/all.pdf}Then, observing that Gay-Neck and his retainers were caught
...
\end{verbatim}
\includepdf[pages=191]{hertel/all.pdf}``Yes,'' said Gold, “I am well aware of this royal duty. It
...
\end{verbatim}
``Why,'' said the crow,
\includepdf[pages=192]{hertel/all.pdf}``you do not even know me by sight. Why should there be strife? Why say a thing so little to the purpose?''
...
\end{verbatim}
\includepdf[pages=193]{hertel/all.pdf}And again:
...
\begin{verbatim}
\includepdf[pages=194]{hertel/all.pdf}Six things are done by friends:
...
\end{verbatim}
\includepdf[pages=195]{hertel/all.pdf}After listening to this, Gold mounted the crow, who set off
...
\includepdf[pages=196]{hertel/all.pdf} in the mouth, toothsome, flavored with sugar, treacle, and
...
\end{verbatim}
\includepdf[pages=197]{hertel/all.pdf}“But this you do not understand, having forgotten friendship
...
\includepdf[pages=198]{hertel/all.pdf}At one time I asked a certain Brahman in a certain town for
...
\end{verbatim}
\includepdf[pages=199]{hertel/all.pdf}“Bearing this in mind, even the poor should give to the right
...
\includepdf[pages=200]{hertel/all.pdf}gleefully thought: “Fate is kind to me, providing this
...
\includepdf[pages=201]{hertel/all.pdf}Then the wife softened the sesame grains in hot water, hulled
...
\includepdf[pages=202]{hertel/all.pdf}``you and I must wake early, so as to follow their tracks together, while the footprints still dirty the floor.''
...
\includepdf[pages=203]{hertel/all.pdf}smeared with drops of blood, followed the trail to the
...
\begin{verbatim}
\includepdf[pages=204]{hertel/all.pdf}The wealthy men are men of force;
...
\includepdf[pages=205]{hertel/all.pdf}ride his back get nothing but buffets{\textemdash}from cats, for
...
\end{verbatim}
\includepdf[pages=206]{hertel/all.pdf}“Yet what have folk like me to do with money? Folk whose
...
\end{verbatim}
\includepdf[pages=207]{hertel/all.pdf}To sum it up:
...
\includepdf[pages=208]{hertel/all.pdf}rhyme puts it:
...
“What's duly his, a man receives.”
\end{verbatim}
\includepdf[pages=209]{hertel/all.pdf}To a second inquirer he gave the same reply. Then on all who
...
\end{verbatim}
\includepdf[pages=210]{hertel/all.pdf}So after full reflection he did not go to her. But Mister
...
\begin{verbatim}
\includepdf[pages=211]{hertel/all.pdf}“What's duly his, a man receives.”
\end{verbatim}
...
\includepdf[pages=212]{hertel/all.pdf}When the story got abroad, dawn had come. And as a great
...
\end{verbatim}
\includepdf[pages=213]{hertel/all.pdf}And again:
...
\includepdf[pages=214]{hertel/all.pdf}Since brother, son, and wife, and friend
...
\end{verbatim}
\includepdf[pages=215]{hertel/all.pdf}From another point of view:
...
\begin{verbatim}
\includepdf[pages=216]{hertel/all.pdf}Some men compacted of self-rigor
...
\includepdf[pages=217]{hertel/all.pdf}Is flattened like a ball of clay.
\end{verbatim}
...
\includepdf[pages=218]{hertel/all.pdf}So twined are Doer and his Deed.
\end{verbatim}
...
\includepdf[pages=219]{hertel/all.pdf}``I am constrained to give the enterprising a reward in proportion to their enterprise. The final consequence is your affair. Take it from him yourself.''
...
sky and said:
\includepdf[pages=220]{hertel/all.pdf}``Do not be so rash, Friend Soft. I am the person who takes your money, who does not allow you one cowrie beyond food and clothes. Now go home. But, that you may not have seen me without result, ask your heart's desire.''
...
\includepdf[pages=221]{hertel/all.pdf}
...
\includepdf[pages=222]{hertel/all.pdf}saying:
...
\includepdf[pages=223]{hertel/all.pdf}One of them was saying:
...
\includepdf[pages=224]{hertel/all.pdf}“And that is why I say:
...
\includepdf[pages=225]{hertel/all.pdf}That joy in bustlings to and fro?
\end{verbatim}
And once again:
...
\includepdf[pages=226]{hertel/all.pdf}Thereupon all three gathered as before.
...
\includepdf[pages=227]{hertel/all.pdf}mouse community, he crushed faces, eyes, heads, and necks of
...
\includepdf[pages=228]{hertel/all.pdf}``We have no means of deliverance except those mice.''
...
\includepdf[pages=229]{hertel/all.pdf}
...
\includepdf[pages=230]{hertel/all.pdf}waited, all looking at me. But I, ignorant of the Jump-Up,
...
\includepdf[pages=231]{hertel/all.pdf}``Why kill the poor beast?'' Furthermore, he penetrated the
...
\end{verbatim}
\includepdf[pages=232]{hertel/all.pdf}At this moment the hunter arrived, bow and arrow in hand.
...
\begin{verbatim}
\includepdf[pages=233]{hertel/all.pdf}In truth, I do not grieve though riches flee;
...
\includepdf[pages=234]{hertel/all.pdf}Now when the hunter saw a deer as good as dead beside the
...
\includepdf[pages=235]{hertel/all.pdf}Here, then, begins Book III, called ``Crows and Owls,'' which
...
\begin{verbatim}
\includepdf[pages=236]{hertel/all.pdf}Good counselors should tell their king,
...
\includepdf[pages=237]{hertel/all.pdf}Shrink like turtles in their shells,
...
\includepdf[pages=238]{hertel/all.pdf}said: “O King, the enemy is vicious and powerful and
...
\includepdf[pages=239]{hertel/all.pdf}One man, entrenched, can hold
...
\includepdf[pages=240]{hertel/all.pdf}ancient, farsighted counselor of his race. This was a crow
...
\includepdf[pages=241]{hertel/all.pdf}him high success.
...
\includepdf[pages=242]{hertel/all.pdf}A king who does not give defense;
...
\end{verbatim}
\includepdf[pages=243]{hertel/all.pdf}And besides:
...
\end{verbatim}
\includepdf[pages=244]{hertel/all.pdf}And there is a saying:
...
\includepdf[pages=245]{hertel/all.pdf}So Four-Tusk, on hearing their report, traveled with them by
...
\end{verbatim}
\includepdf[pages=246]{hertel/all.pdf}And there is a saying:
...
\includepdf[pages=247]{hertel/all.pdf}``Who are you, sir?'' ``I am an envoy,'' said the rabbit.
...
\includepdf[pages=248]{hertel/all.pdf}``It is true, sir. I have sinned against the blessed Moon. Who am I that I should longer contend with him? Pray point out to me, and quickly, the way that I must travel to win the blessèd Moon's forgiveness.''
...
\includepdf[pages=249]{hertel/all.pdf}At one time I was myself living in a certain tree. And
...
\begin{verbatim}
\includepdf[pages=250]{hertel/all.pdf}For ownership of cisterns, tanks,
...
\includepdf[pages=251]{hertel/all.pdf}proverb:
...
\includepdf[pages=252]{hertel/all.pdf}``After all, he is our natural enemy. Let us ask him from a distance.''
...
\end{verbatim}
\includepdf[pages=253]{hertel/all.pdf}And again:
...
\end{verbatim}
\includepdf[pages=254]{hertel/all.pdf}Thereupon he went home with his consort, while the crow
...
\begin{verbatim}
\includepdf[pages=255]{hertel/all.pdf}The strong, deft, clever rascals note,
...
\includepdf[pages=256]{hertel/all.pdf}``do not be angry. Go whither you will.''
...
\includepdf[pages=257]{hertel/all.pdf}In a certain ant-hill lived a prodigious black snake, and his
...
\includepdf[pages=258]{hertel/all.pdf}``Out of my path, you. I take upon myself the chastisement of this traitorous scoundrel.''
...
\includepdf[pages=259]{hertel/all.pdf}number, and their names were Red-Eye, Fierce-Eye, Flame-Eye,
...
\includepdf[pages=260]{hertel/all.pdf}gold dinar in the saucer. So he went there every day alone,
...
\includepdf[pages=261]{hertel/all.pdf}And so, to cut a long story short, a dispute arose.
...
\begin{verbatim}
\includepdf[pages=262]{hertel/all.pdf}He had no comrade on the earth,
...
\includepdf[pages=263]{hertel/all.pdf}“No woman earns the name of bride
...
\includepdf[pages=264]{hertel/all.pdf}In answer to his kindly words
...
\includepdf[pages=265]{hertel/all.pdf}“Henceforth let all enjoyment be
...
\end{verbatim}
\includepdf[pages=266]{hertel/all.pdf}“And that is why I say:
...
\includepdf[pages=267]{hertel/all.pdf}thief entered the house. And she was terrified at seeing a
...
\includepdf[pages=268]{hertel/all.pdf}``I will steal these two cows from this Brahman.'' So he took
...
\includepdf[pages=269]{hertel/all.pdf}“And that is why I say:
...
\includepdf[pages=270]{hertel/all.pdf}city she left the prince to look after the house while she
...
\includepdf[pages=271]{hertel/all.pdf}There was once a carpenter in a certain village. His wife was
...
\includepdf[pages=272]{hertel/all.pdf}this juncture the other fellow arrived and got into bed. And
...
\includepdf[pages=273]{hertel/all.pdf}Then his face blossomed with noiseless laughter, and he did
as she said.
...
\includepdf[pages=274]{hertel/all.pdf}The billows of the Ganges were dotted with pearly foam born
...
\includepdf[pages=275]{hertel/all.pdf}The moon, in mystic fashion, weds
...
\includepdf[pages=276]{hertel/all.pdf}``Here is a daughter of mine. Be kind enough to marry her.''
...
\includepdf[pages=277]{hertel/all.pdf}``Father dear, turn me into a mouse, and give me to him. Then I can keep house as my kind of people ought to do.''
...
\includepdf[pages=278]{hertel/all.pdf}gold. At this the hunter was amazed.
...
\begin{verbatim}
\includepdf[pages=279]{hertel/all.pdf}Joy comes from knowing what to dread,
...
\includepdf[pages=280]{hertel/all.pdf}The lion thereupon called out a greeting. But the cave so
...
\includepdf[pages=281]{hertel/all.pdf}So Cloudy and his followers, taking Live-Strong's advice,
...
\includepdf[pages=282]{hertel/all.pdf}fools anywhere. Not one was sensible except Red-Eye. He,
...
\includepdf[pages=283]{hertel/all.pdf}``Uncle, why don't you bustle about today for food as usual?''
...
\includepdf[pages=284]{hertel/all.pdf}``O King, I have no carrying power today because of lack of food.''
...
husband:
\includepdf[pages=285]{hertel/all.pdf}``There is a shrine of the blessèd goddess not far from here. There I have undertaken a fasting ceremony, and I take an offering, including the most delicious dishes.''
...
The trick was good. All sorts of frogs ....
\end{verbatim}
\includepdf[pages=286]{hertel/all.pdf}and the rest of it. And Water-Foot, hearing this, was
...
\end{verbatim}
And Cloudy replied:
\includepdf[pages=287]{hertel/all.pdf}``It is wonderful how immediate is the reward of knowing social ethics. By virtue of which you penetrated and exterminated Foe-Crusher with his retinue.''
...
\includepdf[pages=288]{hertel/all.pdf}kings is a thing uncertain. Kingly glory is hard to climb as
...
\includepdf[pages=289]{hertel/all.pdf}Here, then, begins Book IV, called ``Loss of Gains.'' The
first verse runs:
...
Then she said:
\includepdf[pages=290]{hertel/all.pdf}``If anyone eats such nectar fruit every day, his heart must be turned to nectar. So, if you value your wife, give me his heart, and I will eat it. Then I shall never grow old or sick, but will be a delightful companion for you.''
...
\begin{verbatim}
\includepdf[pages=292]{hertel/all.pdf}Whoever trusts a faithless friend
    And twice in him believes,
Lays hold on death as certainly
    As when a mule conceives.”
\end{verbatim}
...
\includepdf[pages=293]{hertel/all.pdf}and called: ``Come out! Come out, Handsome! Come out!'' But
...
\begin{verbatim}
\includepdf[pages=294]{hertel/all.pdf}Eat only what will swallow
...
\includepdf[pages=295]{hertel/all.pdf}``you have done what a friend should do. Pray return by way of the buckets.''
...
\end{verbatim}
\includepdf[pages=296]{hertel/all.pdf}Now one day, while eating frogs, he ate a frog named
...
said:
\includepdf[pages=297]{hertel/all.pdf}``My dear sir, your friend Handsome is waiting, waiting for your return. Please hurry back. And furthermore, in case of his doing you any harm, he pledges you the merit acquired in a lifetime. So drop all anxious thoughts, and come home.''
But Theodore said:
...
\includepdf[pages=298]{hertel/all.pdf}So the jackal went hunting, and dragging himself to a nearby
...
\includepdf[pages=299]{hertel/all.pdf}jumped over him and landed on the other side. And the donkey
...
\includepdf[pages=300]{hertel/all.pdf}`If Flop-Ear does not marry me, I will plunge into fire or water, or will eat poison. Anyhow, I cannot bear to be separated from him.'
...
\end{verbatim}
\includepdf[pages=301]{hertel/all.pdf}So the lion was convinced by the jackal's argument, divided
...
\includepdf[pages=302]{hertel/all.pdf}
...
\begin{verbatim}
\includepdf[pages=303]{hertel/all.pdf}Never strike a hermit mild,
...
\includepdf[pages=304]{hertel/all.pdf}
...
\includepdf[pages=305]{hertel/all.pdf}There was once a Brahman in a certain city who loved his wife
...
\includepdf[pages=306]{hertel/all.pdf}``From this moment I give you my person for life. You must accompany us with this understanding.''
``Very well,'' said he.
...
\includepdf[pages=307]{hertel/all.pdf}``there comes my husband's enemy.''
...
\includepdf[pages=308]{hertel/all.pdf}Now Joy's wife became angry in just the same way, and would
...
\includepdf[pages=309]{hertel/all.pdf}passed, he grew plump. He could hardly squeeze into the
stall.
...
\includepdf[pages=310]{hertel/all.pdf}There was once a farmer who lived with his wife in a certain
...
\includepdf[pages=311]{hertel/all.pdf}``Do so, my belovèd,'' said she.
...
\end{verbatim}
\includepdf[pages=312]{hertel/all.pdf}“How true it is that misfortunes never come singly! Well,
...
The plover lies with claws upstretched
    To prop the falling sky.”
\end{verbatim}
\includepdf[pages=313]{hertel/all.pdf}Thereupon he said to her:
...
\includepdf[pages=314]{hertel/all.pdf}At this moment a lion, in his wanderings to and fro, came to
...
\includepdf[pages=315]{hertel/all.pdf}``My dear nephew, make me a gift of my life. Even if he is slow in returning, don't give him any news of me.''
...
\end{verbatim}
\includepdf[pages=316]{hertel/all.pdf}made a dash at him, tore him with his fangs, made him seek
...
\end{verbatim}
\includepdf[pages=317]{hertel/all.pdf}So the crocodile, having received his friend's advice,
...
\includepdf[pages=318]{hertel/all.pdf}Here, then, begins Book V, called ``Ill-considered Action.''
...
monk, and said:
\includepdf[pages=319]{hertel/all.pdf}``Good merchant, do not lose interest. I am a trillion, earned by your ancestors. Tomorrow morning I will come to your house in this same form. Then you must club me on the head, so that I may turn to gold and prove inexhaustible.''
...
\includepdf[pages=320]{hertel/all.pdf}When he arrived there, he got ready cudgels of acacia wood,
...
\includepdf[pages=321]{hertel/all.pdf}she cared for the mungoose also like a son, giving him milk
...
\includepdf[pages=322]{hertel/all.pdf}bitterly lamenting her son, the mungoose. ``Greedy! Greedy!''
...
\begin{verbatim}
\includepdf[pages=323]{hertel/all.pdf}A beggar to the graveyard hied
And there ‘Friend corpse, arise,’ he cried;
‘One moment lift my heavy weight
Of poverty; for I of late
Grow weary, and desire instead
...
\end{verbatim}
\includepdf[pages=324]{hertel/all.pdf}Likewise:
...
\includepdf[pages=325]{hertel/all.pdf}him to his monastery cell. There the magician asked them
...
said:
\includepdf[pages=325]{hertel/all.pdf}``Fool! What is the good of a thing which, even in quantity, does not put an end to poverty? Stand up. Let us go on.''
...
and said:
\includepdf[pages=327]{hertel/all.pdf}``Sir, why do you stand thus with a wheel whirling on your head? In any case, tell me if there is water anywhere. I am mad with thirst.''
...
\includepdf[pages=328]{hertel/all.pdf} tortured by a cruel wheel whirling on his head{\textemdash}and this man
...
But the third said:
\includepdf[pages=329]{hertel/all.pdf}``No, no. This is no way to behave. For we have played together since we were little boys. Come along, my noble friend. You shall have a share of the money we earn.''
...
\includepdf[pages=330]{hertel/all.pdf}In a certain pond lived two fishes whose names were
...
\includepdf[pages=331]{hertel/all.pdf}So spoke the frog and under cover of night he went to another
...
\includepdf[pages=332]{hertel/all.pdf}night. One night while wandering in the fields he fell in
...
\includepdf[pages=333]{hertel/all.pdf}One hundred songs and eighty-five
...
\begin{verbatim}
\includepdf[pages=334]{hertel/all.pdf}He who, lacking wit, does not
    Harken to a friend,
...
And the barber said:
\includepdf[pages=335]{hertel/all.pdf}``My dear fellow, if it is really so, ask for a kingdom. You can be king, and I will be prime minister. So we shall both taste the delights of this world before those of the world to come.''
...
\end{verbatim}
\includepdf[pages=336]{hertel/all.pdf}“Besides, this king-business means a series of dreadful
...
\includepdf[pages=337]{hertel/all.pdf}In a certain town lived a Brahman named Seedy, who got some
...
\includepdf[pages=338]{hertel/all.pdf}“And that is why I say:
...
\includepdf[pages=339]{hertel/all.pdf}
...
\includepdf[pages=340]{hertel/all.pdf}blazing, he plunged bleating into the stable near by. There
...
\includepdf[pages=341]{hertel/all.pdf}with a pearl necklace adorning his neck, who spoke and said:
...
\includepdf[pages=342]{hertel/all.pdf}And the king in his palanquin clasped the monkey to his
...
\includepdf[pages=343]{hertel/all.pdf}When the king heard this, he hastened home, grief-stricken.
...
\includepdf[pages=344]{hertel/all.pdf}In a certain city lived a king whose name was Fine-Army. He
...
\includepdf[pages=345]{hertel/all.pdf}When the thief perceived how little he minded the tugging at
...
\begin{verbatim}
\includepdf[pages=346]{hertel/all.pdf}Blind man, hunchback, and unblest
...
\includepdf[pages=347]{hertel/all.pdf}Soon the Brahman, while meditating a plan of escape, came to
...
\includepdf[pages=348]{hertel/all.pdf}Now there was a blind man in the city, and as companion he
...
and she said:
\includepdf[pages=349]{hertel/all.pdf}``My belovèd, if this blind man happened to be killed, we should live happily together. Please find some poison. I will administer it, will kill him, and will become happy.''
...
\includepdf[pages=350]{hertel/all.pdf}
